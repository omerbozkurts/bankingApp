...
class Bank:
    ...
    def girisEkran(self):
        ...
        kullaniciAdilbl=Label(girisFrame2,text="Tc Kimlik No",width=40,)
        kullaniciAdilbl.pack()
        kullaniciAdi=Entry(girisFrame2,width="40")
        kullaniciAdi.pack()
        ...
        sifreLbl=Label(girisFrame3,text="Sifre",width=40,)
        sifreLbl.pack()
        sifre=Entry(girisFrame3,width="40")
        sifre.pack()
        ...
        kullaniciAdi=kullaniciAdi.get()
        sifre=sifre.get()
        kullanici=Kullanici()
        loginButton=Button(girisFrame4,bg="yellow",text='giris yap',width=30,height=2,command=kullanici.girisYap(kullaniciAdi,sifre))
        loginButton.pack()
